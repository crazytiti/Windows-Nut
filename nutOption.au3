...
$optionList = $optionList & "int minimizeonstartup;"
$optionList = $optionList & "int reconnect;"
...
Func ReadParams()
	...
	Else
		...
		ReadParam("minimizeonstartup" , "Appearance" , "number" , "0" , "Minimize on startup")
		ReadParam("reconnect" , "Connection" , "number" , "0" , "Reconnect")
...
Func WriteParams()
	...
	IniWrite($inipath , "Appearance","Minimize on startup",GetOption("minimizeonstartup"))
	IniWrite($inipath , "Connection","Reconnect",GetOption("reconnect"))
